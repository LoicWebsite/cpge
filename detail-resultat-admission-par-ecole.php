...
&nbsp;&nbsp;&nbsp;
	...
	<script>
		...
		function questionnaire() {
			<?php
				echo "window.location.href='statistique-integration-ecole-d-ingenieur-par-ecole-cpge-post-prepa.php?reference=" . $reference . "&filiere=" . $filiere . "&concours=" . $concours . "&ecole=" . supprimerApostrophe($ecole) . "'";
			?>
		}
	</script>		
  </body>
