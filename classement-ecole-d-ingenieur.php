	...
	<header class='container'>
		...
		<div class="collapse" id="detail" style="margin-left:20px;">
			<p>3 classements sont présentés :
				<ul>
					<li>Le classement du site <a href='https://www.daur-rankings.com/rankings/' target=_blank tittle='vers le site DAUR'>DAUR Rankings</a> a évalué 185 écoles sous statut étudiant en 2024 et 176 en 2023.
					...
					<br>
					<li>Le classement du magazine <a href='https://etudiant.lefigaro.fr/etudes/ecoles-ingenieurs/classement/' target=_blank tittle='vers le site Le Figaro étudiant'>Le Figaro étudiant</a> a évalué 87 écoles post prépa en 2025 et 2024.
					...
					<br>
					<li>Le classement du magazine <a href='https://www.letudiant.fr/classements/classement-des-ecoles-d-ingenieurs.html' target=_blank tittle='vers le site de L&apos;Etudiant'>L'Etudiant</a> a évalué 169 écoles en 2023 (172 en 2022) sur environ 200 écoles certifiées par la CTI.
						Certaines écoles sont absentes de ce classement, par exemple les ENS, l'Ecole Navale ou l'Ecole de l'Air.
	...
	<main class='container'>
		...
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<button class="nav-link active" id="tab-daur-2024" data-bs-toggle="tab" data-bs-target="#daur-2024" type="button" role="tab" aria-controls="daur 2023" aria-selected="false">DAUR<br>2024</button>
				<button class="nav-link" id="tab-daur-2023" data-bs-toggle="tab" data-bs-target="#daur-2023" type="button" role="tab" aria-controls="daur 2022" aria-selected="false">DAUR<br>2023</button>
				...
				<button class="nav-link" id="tab-etudiant-2022" data-bs-toggle="tab" data-bs-target="#etudiant-2022" type="button" role="tab" aria-controls="etudiant 2022" aria-selected="true">L'Etudiant<br>2022</button>
			</div>
		</nav>
		...
		<div class="tab-content" id="nav-tabContent">
			...
			<!-- ouverture de l'onglet DAUR 2024 -->
			<div class="tab-pane fade show active" id="daur-2024" role="tabpanel" aria-labelledby="tab-daur-2024">
			<?php
				...
				try {
					...
					echo "<tr>";
					echo "<th>&nbsp;Notation&nbsp;<br><i class='fas fa-info-circle' data-bs-toggle='tooltip' data-bs-html='true' title='La notation de l&apos;école en 2024 est défini par le site DAUR Rankings selon la note finale obtenue par l&apos;école dans son classement.<br>AAA : 100 à 70<br>AA : 69 à 54<br>A : 53 à 47 points<br>BBB : 46 à 41<br>BB : 40 à 37<br>B : 36 à 34<br>CCC : 33 à 31<br>CC : 30 à 28<br>C : 27 à 0'></i></th>";
			...
			<!-- ouverture de l'onglet DAUR 2023 -->
			...
			<?php
				...
				try {
					...
					echo "<thead class='text-center'>";
					echo "<tr>";
					echo "<th>&nbsp;Notation&nbsp;<br><i class='fas fa-info-circle' data-bs-toggle='tooltip' data-bs-html='true' title='La notation de l&apos;école en 2023 est défini par le site DAUR Rankings selon la note finale obtenue par l&apos;école dans son classement.<br>AAA : 100 à 70<br>AA : 69 à 56<br>A : 55 à 49 points<br>BBB : 48 à 44<br>BB : 43 à 39<br>B : 39 à 35<br>CCC : 34 à 32<br>CC : 31 à 29<br>C : 29 à 0'></i></th>";
			...
			<div class="tab-pane fade" id="figaro-2025" role="tabpanel" aria-labelledby="tab-figaro">
			<?php
				...
				try {
					...
					echo "<th>&nbsp;Note&nbsp;<br><i class='fas fa-info-circle' data-bs-toggle='tooltip' data-bs-html='true' title='Les écoles sont notées en 2025 de 0 à 20. Cette note résulte de l&apos;évaluation de 14 critères.'></i></th>";
					echo "<th>&nbsp;Ecole&nbsp;</th>";
		...
		// 				$class = " class='nouvelEcole'";
			...
			<div class="tab-pane fade" id="figaro-2024" role="tabpanel" aria-labelledby="tab-figaro">
			<?php
